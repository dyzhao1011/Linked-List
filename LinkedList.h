...
/* The following method provides the user with the ability to access or change the linked list.
   1. printMenu(): displays a list of options for the user to choose from. The user chooses an option by typing and entering a 
   capital letter. An error message is displayed if an invalid option is chosen.
